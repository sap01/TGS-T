...
Ref: https://github.com/cran/minet/blob/662cd27b4a7bf0067237a0c698451754de623419/src/clr.cpp 

To compile this file do: R CMD SHLIB clr.cpp
...
* Implements CLR1.3 
*/
SEXP clr1dot3( SEXP Rmim, SEXP Rsize,SEXP RskipDiagonal)
{
  const double *mim;
  const int *size;
  double *res, *avg, *var, tmp, zi, zj;
